              ...
              <div className="space-y-5">
                {contactInfo.social.map((social, index) => (
                  <motion.a
                    ...
                    className="flex items-center gap-4 group hover:bg-veldheer-dark p-4 transition-all duration-300 border-b-2 border-veldheer-gold/20 hover:border-veldheer-gold"
                  >
                    {/* Platform Icon */}
                    <div className="flex-shrink-0 text-veldheer-gold group-hover:text-white transition-colors duration-300">
                    ...
                    {/* Arrow Icon */}
                    <svg
                      className="w-6 h-6 flex-shrink-0 text-veldheer-gold transform group-hover:translate-x-2 transition-transform duration-300"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
