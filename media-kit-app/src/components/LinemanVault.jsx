    ...
    >
      <div className="container mx-auto px-6 lg:px-8 max-w-6xl">
        <div className="max-w-7xl mx-auto">
          ...
          {/* What the Vault Is - with VLVL logo background */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={isInView ? { opacity: 1, y: 0 } : {}}
          ...
          >
            ...
            <div className="relative z-10 max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl lg:text-3xl text-gray-200 leading-relaxed font-body font-normal">
          ...
          >
            ...
            >
              <span>{isExpanded ? 'Show Less' : 'Learn More About The Vault'}</span>
              <svg
